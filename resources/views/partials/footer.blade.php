            ...
            <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                <div class="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                    <ul class="list-disc list-inside space-y-8">
                        <li><a href="#" class="hover:text-sky-400 transition">Opencommons</a></li>

                        <li><a href="#" class="hover:text-sky-400 transition">Powered</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Qualiopi</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Factoria</a></li>
                        <li><a href="#" class="hover:text-sky-400 transition">Team TEXPA</a></li>
...
Bonne chance ❤️  <a href="#" target="_blank">Annee 2023</a></section>
</section>